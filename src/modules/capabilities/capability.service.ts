...
export class CapabilityService {
  constructor(
    ...
    private readonly treeRepository: TreeRepository<
      Capability
    > /*
    @InjectRepository(DefaultCapability)
    private readonly defaultCapabilityRepository: Repository<DefaultCapability>,
    @InjectRepository(DefaultCapability)
    private readonly defaultTreeRepository: TreeRepository<DefaultCapability>*/
  ) {}
